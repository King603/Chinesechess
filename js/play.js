...
let play = {
  init() {
    ...
    //   play.AIPlay();
    // });
    // com.get("offensivePlay").addEventListener("click", () => {
    //   play.isOffensive = !0;
    //   play.isPlay = !0;
    //   com.get("chessRight").style.display = "none";
    //   play.init();
    // });
    // com.get("defensivePlay").addEventListener("click", () => {
    //   play.isOffensive = !1;
    //   play.isPlay = !0;
    //   com.get("chessRight").style.display = "none";
    //   play.init();
    // });
    com.get("regretBn").addEventListener("click", () => play.regret());
  ...
  // 获得点击的着点
  getClickPoint(e) {
    let { x: domX, y: domY } = com.getDomXY(com.canvas);
    let x = Math.round((e.pageX - domX - com.pointStartX - 20) / com.spaceX);
    let y = Math.round((e.pageY - domY - com.pointStartY - 20) / com.spaceY);
    return { "x": x, "y": y }
  },
  // 获得棋子
  getClickMan(e) {
